...
dataset2="MIR_1K|MedleyDB_segment" #Semi-Supervised Dataset, ["MIR_1K", "MIR_1K_Polyphonic", "Pop_Rhythm", "DALI_train", "DALI_orig_train", "DALI_demucs_train", "MedleyDB", "MedleyDB_segment", "CMedia", "CMedia_demucs"]
